...
class ProductList extends Component {
    ...
    renderLoader() {
        ...
        <FlatList
                ...
                <Text>{item.SKU} | {item.name} | {item.RRP} </Text>
                <View style={{
                        flexDirection: 'row',
                        flexWrap: 'wrap'
                    }}>
                  <Button light style={styles.Button} onPress={this.productSelected.bind(this, item)}>
                  <Text>Purchase</Text>
                  </Button>
          </View>
        </View>}
    ...
    render() {
      ...
      <Item rounded>
      <Input placeholder='Search...' text={this.state.searchStr} onChangeText={searchStr => this.setState({
                searchStr
            })}/>
      </Item>
